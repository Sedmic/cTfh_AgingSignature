...
qCXCL11 <-   ggplot(data=luminex, aes(x=Day,y=CXCL11)) + geom_violin(data=subset(luminex,Day==c(0,7) & AgeCategory=="Young",stat="identity"), aes(fill=Day)) + theme_bw() +
  ...
  ggtitle("CXCL11") + theme(plot.title = element_text(size=24,hjust = 0.5)) + ylab("CXCL11 (pg/mL)") 
qFractaline <- ggplot(data=luminex, aes(x=Day,y=Fractaline)) + geom_violin(data=subset(luminex,Day==c(0,7) & AgeCategory=="Young",stat="identity"), aes(fill=Day)) + theme_bw() +
  ...
  ggtitle("Fractaline") + theme(plot.title = element_text(size=24,hjust = 0.5)) + ylab("Fractaline (pg/mL)") 
qMIP3a <- ggplot(data=luminex, aes(x=Day,y=MIP3a)) + geom_violin(data=subset(luminex,Day==c(0,7) & AgeCategory=="Young",stat="identity"), aes(fill=Day)) + theme_bw() +
  geom_boxplot(width=0.1, data=subset(luminex,Day==c(0,7) & AgeCategory=="Young",stat="identity")) + scale_fill_brewer(palette="Dark2") +
  ggtitle("MIP3a") + theme(plot.title = element_text(size=24,hjust = 0.5)) + ylab("MIP3a (pg/mL)") 
qIL7 <- ggplot(data=luminex, aes(x=Day,y=IL7)) + geom_violin(data=subset(luminex,Day==c(0,7) & AgeCategory=="Young",stat="identity"), aes(fill=Day)) + theme_bw() +
  geom_boxplot(width=0.1, data=subset(luminex,Day==c(0,7) & AgeCategory=="Young",stat="identity")) + scale_fill_brewer(palette="Dark2") +
  ggtitle("IL7") + theme(plot.title = element_text(size=24,hjust = 0.5)) + ylab("IL7 (pg/mL)") 
qIL8 <- ggplot(data=luminex, aes(x=Day,y=IL8)) + geom_violin(data=subset(luminex,Day==c(0,7) & AgeCategory=="Young",stat="identity"), aes(fill=Day)) + theme_bw() +
  geom_boxplot(width=0.1, data=subset(luminex,Day==c(0,7) & AgeCategory=="Young",stat="identity")) + scale_fill_brewer(palette="Dark2") +
  ggtitle("IL8") + theme(plot.title = element_text(size=24,hjust = 0.5)) + ylab("IL8 (pg/mL)") 
qMIP1b <- ggplot(data=luminex, aes(x=Day,y=MIP1b)) + geom_violin(data=subset(luminex,Day==c(0,7) & AgeCategory=="Young",stat="identity"), aes(fill=Day)) + theme_bw() +
  geom_boxplot(width=0.1, data=subset(luminex,Day==c(0,7) & AgeCategory=="Young",stat="identity")) + scale_fill_brewer(palette="Dark2") +
  ggtitle("MIP1b") + theme(plot.title = element_text(size=24,hjust = 0.5)) + ylab("MIP1b (pg/mL)") 
qTNF <- ggplot(data=luminex, aes(x=Day,y=TNFa)) + geom_violin(data=subset(luminex,Day==c(0,7) & AgeCategory=="Young",stat="identity"), aes(fill=Day)) + theme_bw() +
  geom_boxplot(width=0.1, data=subset(luminex,Day==c(0,7) & AgeCategory=="Young",stat="identity")) + scale_fill_brewer(palette="Dark2") +
  ggtitle("TNF") + theme(plot.title = element_text(size=24,hjust = 0.5)) + ylab("TNF (pg/mL)") 
qLeptin <- ggplot(data=luminex, aes(x=Day,y=Leptin)) + geom_violin(data=subset(luminex,Day==c(0,7) & AgeCategory=="Young",stat="identity"), aes(fill=Day)) + theme_bw() +
  geom_boxplot(width=0.1, data=subset(luminex,Day==c(0,7) & AgeCategory=="Young",stat="identity")) + scale_fill_brewer(palette="Dark2") +
  ggtitle("Leptin") + theme(plot.title = element_text(size=24,hjust = 0.5)) + ylab("Leptin (pg/mL)") 
qHGF <- ggplot(data=luminex, aes(x=Day,y=HGF)) + geom_violin(data=subset(luminex,Day==c(0,7) & AgeCategory=="Young",stat="identity"), aes(fill=Day)) + theme_bw() +
  geom_boxplot(width=0.1, data=subset(luminex,Day==c(0,7) & AgeCategory=="Young",stat="identity")) + scale_fill_brewer(palette="Dark2") +
  ggtitle("HGF") + theme(plot.title = element_text(size=24,hjust = 0.5)) + ylab("HGF (pg/mL)") 
qAdiponectin <- ggplot(data=luminex, aes(x=Day,y=Adiponectin)) + geom_violin(data=subset(luminex,Day==c(0,7) & AgeCategory=="Young",stat="identity"), aes(fill=Day)) + theme_bw() +
  geom_boxplot(width=0.1, data=subset(luminex,Day==c(0,7) & AgeCategory=="Young",stat="identity")) + scale_fill_brewer(palette="Dark2") +
  ggtitle("Adiponectin") + theme(plot.title = element_text(size=18,hjust = 0.5)) + ylab("Adiponectin (pg/mL)") 
qMCP1 <- ggplot(data=luminex, aes(x=Day,y=MCP1)) + geom_violin(data=subset(luminex,Day==c(0,7) & AgeCategory=="Young",stat="identity"), aes(fill=Day)) + theme_bw() +
  geom_boxplot(width=0.1, data=subset(luminex,Day==c(0,7) & AgeCategory=="Young",stat="identity")) + scale_fill_brewer(palette="Dark2") +
  ggtitle("MCP1") + theme(plot.title = element_text(size=24,hjust = 0.5)) + ylab("MCP1 (pg/mL)") 
qResistin <- ggplot(data=luminex, aes(x=Day,y=Resistin)) + geom_violin(data=subset(luminex,Day==c(0,7) & AgeCategory=="Young",stat="identity"), aes(fill=Day)) + theme_bw() +
  geom_boxplot(width=0.1, data=subset(luminex,Day==c(0,7) & AgeCategory=="Young",stat="identity")) + scale_fill_brewer(palette="Dark2") +
  ggtitle("Resistin") + theme(plot.title = element_text(size=24,hjust = 0.5)) + ylab("Resistin (pg/mL)") 
...
# ggexport(a, filename = "../../../Luminex/Year4_Luminex/Images/AllChemokinesByDay_Young.png")
ggexport(a, filename = "../../../Luminex/Year4_Luminex/Images/AllChemokinesByDay_Young.eps")
...
a <- ggarrange(qCXCL11, qFractaline, qMIP3a, qIL7, qIL8, qMIP1b, qTNF, qLeptin, qHGF, qAdiponectin, qMCP1, qResistin, common.legend = TRUE, legend="right")
# ggexport(a, filename = "../../../Luminex/Year4_Luminex/Images/AllChemokinesByDay_Elderly.png")
ggexport(a, filename = "../../../Luminex/Year4_Luminex/Images/AllChemokinesByDay_Elderly.eps")
...
ggplot(data=phenotypeMatrix, aes(x=`ASC.freqLive`,y=`cTfh_ICOShi.CD38hi...Freq..of`, fill=`Identifier`)) + theme_bw() +  theme(legend.position = "none") +
  ...
  scale_fill_manual(values=c('purple','#E69F00')) + scale_color_manual(values=c('purple', '#E69F00')) + annotation_custom(my_grob1) + annotation_custom(my_grob2)
# ggsave(filename = "Images/HiHiresponse_vs_ASC_byAge.png", device="png")
# ggsave(filename = "Images/HiHiresponse_vs_ASC_byAge.eps", device="eps")
...
ggplot(data=phenotypeMatrix, aes(x=`ASC.freqLive`,y=`cTfh_ICOShi.CD38hi...Freq..of`, fill=`Identifier`)) + theme_bw() +  theme(legend.position = "none") +
  ...
  scale_fill_manual(values=c('purple','#E69F00')) + scale_color_manual(values=c('purple', '#E69F00')) + annotation_custom(my_grob1) + annotation_custom(my_grob2)
# ggsave(filename = "Images/HiHiresponse_vs_ASC_byAge_OUTLIERREMOVED.png", device="png")
# ggsave(filename = "Images/HiHiresponse_vs_ASC_byAge_OUTLIERREMOVED.eps", device="eps")
phenotypeMatrix <- read.csv(file="../../Analysis/BAA_yr4_AllMergedData_FC.csv"); phenotypeMatrix <- phenotypeMatrix[-c(62:73),]; rownames(phenotypeMatrix) <- phenotypeMatrix$Subject; 
phenotypeMatrix$Subject <- NULL
phenotypeMatrixYoung <- subset(phenotypeMatrix,Identifier=="Young",stat="identity")
phenotypeMatrixElderly <- subset(phenotypeMatrix,Identifier=="Elderly",stat="identity")
...
ggplot(data=phenotypeMatrix, aes(x=`H1N1.nAb.FCd28`,y=`cTfh_ICOShi.CD38hi...Freq..of`, fill=`Identifier`)) + theme_bw() +  theme(legend.position = "none") +
  ...
  geom_point(data=subset(phenotypeMatrix,Identifier=="Young",stat="identity"), size=6, pch=21) +  #ylim(-1,1) + xlim(0,3)+
  theme(axis.text = element_text(size=16,hjust = 0.5))+theme(axis.title = element_text(size=24,hjust = 0.5))+
  ggtitle("ICOS+CD38+ cTfh vs H1N1.nAb.FCd28") + theme(plot.title = element_text(size=28,hjust = 0.5)) + ylab("ICOShiCD38hi cTfh foldchange")  + xlab("H1N1.nAb.FCd28")+
  scale_fill_manual(values=c('purple','#E69F00')) + scale_color_manual(values=c('purple', '#E69F00')) + annotation_custom(my_grob1) + annotation_custom(my_grob2)
# ggsave(filename = "Images/HiHiresponse_vs_ASC_byAge_OUTLIERREMOVED.eps", device="eps")



#  ASC vs Tfh response - YOUNG ONLY  not for manuscript figure
phenotypeMatrix <- phenotypeMatrix[-which(phenotypeMatrix$ASC.freqLive == max(phenotypeMatrix$ASC.freqLive, na.rm=T)),]
phenotypeMatrix <- phenotypeMatrix[-which(phenotypeMatrix$ASC.freqLive == max(phenotypeMatrix$ASC.freqLive, na.rm=T)),]
phenotypeMatrixYoung <- phenotypeMatrixYoung[-which(phenotypeMatrixYoung$ASC.freqLive==max(phenotypeMatrixYoung$ASC.freqLive,na.rm=T)),]
phenotypeMatrixElderly <- phenotypeMatrixElderly[-which(phenotypeMatrixElderly$ASC.freqLive==max(phenotypeMatrixElderly$ASC.freqLive,na.rm=T)),]
...
ggplot(data=phenotypeMatrix, aes(x=`TNFa`,y=`cTfh_ICOShi.CD38hi...Freq..of`, fill=`Identifier`)) + theme_bw() +  theme(legend.position = "none") +
  ...
  scale_fill_manual(values=c('purple','#E69F00')) + scale_color_manual(values=c('purple', '#E69F00')) + annotation_custom(my_grob1) + annotation_custom(my_grob2)
# ggsave(filename = "Images/HiHiresponse_vs_TNF_byAge.png", device="png")
...
# H1N1 IgM d7 vs TNF
a <- cor.test(phenotypeMatrixYoung$H1N1.IgM.FCd7, phenotypeMatrixYoung$TNFa, use="complete")
b <- cor.test(phenotypeMatrixElderly$H1N1.IgM.FCd7, phenotypeMatrixElderly$TNFa, use="complete")
annotationInfo <- paste0("r= ", round(a$estimate,2),";  ", "p = ", round(a$p.value,2))
annotationInfo2 <- paste0("r= ", round(b$estimate,2), ";  ", "p = ", round(b$p.value,2))
my_grob1 = grobTree(textGrob(annotationInfo, x=0.65,  y=0.93, hjust=0, gp=gpar(col="orange3", fontsize=18)))
my_grob2 = grobTree(textGrob(annotationInfo2, x=0.65,  y=0.88, hjust=0, gp=gpar(col="purple", fontsize=18)))  
ggplot(data=phenotypeMatrix, aes(x=`H1N1.IgM.FCd7`,y=TNFa, fill=`Identifier`)) + theme_bw() +  theme(legend.position = "none") +
  geom_smooth(method=lm, se=F, fullrange=T, size=2, alpha=0.1, aes(color=Identifier)) + 
  geom_point(data=subset(phenotypeMatrix,Identifier=="Elderly",stat="identity"), size=6, pch=21) + 
  geom_point(data=subset(phenotypeMatrix,Identifier=="Young",stat="identity"), size=6, pch=21) +  
  theme(axis.text = element_text(size=16,hjust = 0.5))+theme(axis.title = element_text(size=24,hjust = 0.5))+
  ggtitle("TNF vs H1N1 IgM FCd7") + theme(plot.title = element_text(size=28,hjust = 0.5)) + ylab("TNF (pg/mL)")  +xlab("Fold change of day 7 vs 0") +  
  scale_fill_manual(values=c('purple','#E69F00')) + scale_color_manual(values=c('purple', '#E69F00'))+ annotation_custom(my_grob1) + annotation_custom(my_grob2)
# ggsave(filename = "../../Analysis/Antibody data/Images/H1N1_IgM_FCd7_YandE_scatter.png", device="png")
cor.test(phenotypeMatrixYoung$H1N1.IgM.FCd7, phenotypeMatrixYoung$TNFa, use="complete")
cor.test(phenotypeMatrixElderly$H1N1.IgM.FCd7, phenotypeMatrixElderly$TNFa, use="complete")
...
# H3N2 IgM d7 vs TNF
a <- cor.test(phenotypeMatrixYoung$H3N2.IgM.FCd7, phenotypeMatrixYoung$TNFa, use="complete")
b <- cor.test(phenotypeMatrixElderly$H3N2.IgM.FCd7, phenotypeMatrixElderly$TNFa, use="complete")
annotationInfo <- paste0("r= ", round(a$estimate,2), ";  ","p = ", round(a$p.value,2))
annotationInfo2 <- paste0("r= ", round(b$estimate,2),";  ", "p = ", round(b$p.value,2))
my_grob1 = grobTree(textGrob(annotationInfo, x=0.85,  y=0.95, hjust=0, gp=gpar(col="orange3", fontsize=18)))
my_grob2 = grobTree(textGrob(annotationInfo2, x=0.85,  y=0.85, hjust=0, gp=gpar(col="purple", fontsize=18)))  
ggplot(data=phenotypeMatrix, aes(x=`H3N2.IgM.FCd7`,y=TNFa, fill=`Identifier`)) + theme_bw() +  theme(legend.position = "none") +
  geom_smooth(method=lm, se=F, fullrange=T, size=2, alpha=0.1, aes(color=Identifier)) + 
  geom_point(data=subset(phenotypeMatrix,Identifier=="Elderly",stat="identity"), size=6, pch=21) + 
  geom_point(data=subset(phenotypeMatrix,Identifier=="Young",stat="identity"), size=6, pch=21) +   
  theme(axis.text = element_text(size=16,hjust = 0.5))+theme(axis.title = element_text(size=24,hjust = 0.5))+
  ggtitle("TNF vs H3N2 IgM FCd7") + theme(plot.title = element_text(size=28,hjust = 0.5)) + ylab("TNF (pg/mL)")  + xlab("Fold change of day 7 vs 0") + 
  scale_fill_manual(values=c('purple','#E69F00')) + scale_color_manual(values=c('purple', '#E69F00'))+ annotation_custom(my_grob1) + annotation_custom(my_grob2)
# ggsave(filename = "../../Analysis/Antibody data/Images/H3N2_IgM_FCd7_YandE_scatter.png", device="png")
cor.test(phenotypeMatrixYoung$H3N2.IgM.FCd7, phenotypeMatrixYoung$TNFa, use="complete")
cor.test(phenotypeMatrixElderly$H3N2.IgM.FCd7, phenotypeMatrixElderly$TNFa, use="complete")
...
ggplot(data=phenotypeMatrix[-1,], aes(x=`H1N1.IgG.FCd28`,y=TNFa, fill=`Identifier`)) + theme_bw() +  theme(legend.position = "none") +  # exclude row 1 because d28 sample not available for that person
  ...
  scale_fill_manual(values=c('purple','#E69F00')) + scale_color_manual(values=c('purple', '#E69F00'))+ annotation_custom(my_grob1) + annotation_custom(my_grob2)
# ggsave(filename = "../../Analysis/Antibody data/Images/H1N1_IgG_FCd28_YandE_scatter.png", device="png")
...
# H1N1 IgG d7 vs TNF
a <- cor.test(phenotypeMatrixYoung$H1N1.IgG.FCd7, phenotypeMatrixYoung$TNFa, use="complete")
b <- cor.test(phenotypeMatrixElderly$H1N1.IgG.FCd7, phenotypeMatrixElderly$TNFa, use="complete")
annotationInfo <- paste0("r= ", round(a$estimate,2),";  ", "p = ", round(a$p.value,2))
annotationInfo2 <- paste0("r= ", round(b$estimate,2), ";  ", "p = ", round(b$p.value,2))
my_grob1 = grobTree(textGrob(annotationInfo, x=0.65,  y=0.93, hjust=0, gp=gpar(col="orange3", fontsize=18)))
my_grob2 = grobTree(textGrob(annotationInfo2, x=0.65,  y=0.88, hjust=0, gp=gpar(col="purple", fontsize=18))) 
ggplot(data=phenotypeMatrix, aes(x=`H1N1.IgG.FCd7`,y=TNFa, fill=`Identifier`)) + theme_bw() +  theme(legend.position = "none") +
  geom_smooth(method=lm, se=F, fullrange=T, size=2, alpha=0.1, aes(color=Identifier)) + 
  geom_point(data=subset(phenotypeMatrix,Identifier=="Elderly",stat="identity"), size=6, pch=21) + 
  geom_point(data=subset(phenotypeMatrix,Identifier=="Young",stat="identity"), size=6, pch=21) +  
  theme(axis.text = element_text(size=16,hjust = 0.5))+theme(axis.title = element_text(size=24,hjust = 0.5))+
  ggtitle("TNF vs H1N1 IgG FCd7") + theme(plot.title = element_text(size=28,hjust = 0.5)) + ylab("TNF (pg/mL)")  + xlab("Fold change of day 7 vs 0") + 
  scale_fill_manual(values=c('purple','#E69F00')) + scale_color_manual(values=c('purple', '#E69F00'))+ annotation_custom(my_grob1) + annotation_custom(my_grob2)
# ggsave(filename = "../../Analysis/Antibody data/Images/H1N1_IgG_FCd7_YandE_scatter.png", device="png")
cor.test(phenotypeMatrixYoung$H1N1.IgG.FCd7, phenotypeMatrixYoung$TNFa, use="complete")
cor.test(phenotypeMatrixElderly$H1N1.IgG.FCd7, phenotypeMatrixElderly$TNFa, use="complete")
...
# H3N2 IgG d7 vs TNF
a <- cor.test(phenotypeMatrixYoung$H3N2.IgG.FCd7, phenotypeMatrixYoung$TNFa, use="complete")
b <- cor.test(phenotypeMatrixElderly$H3N2.IgG.FCd7, phenotypeMatrixElderly$TNFa, use="complete")
annotationInfo <- paste0("r= ", round(a$estimate,2), ";  ", "p = ", round(a$p.value,2))
annotationInfo2 <- paste0("r= ", round(b$estimate,2),  ";  ", "p = ", round(b$p.value,2))
my_grob1 = grobTree(textGrob(annotationInfo, x=0.65,  y=0.93, hjust=0, gp=gpar(col="orange3", fontsize=18)))
my_grob2 = grobTree(textGrob(annotationInfo2, x=0.65,  y=0.88, hjust=0, gp=gpar(col="purple", fontsize=18))) 
ggplot(data=phenotypeMatrix, aes(x=`H3N2.IgG.FCd7`,y=TNFa, fill=`Identifier`)) + theme_bw() +  theme(legend.position = "none") +
  geom_smooth(method=lm, se=F, fullrange=T, size=2, alpha=0.1, aes(color=Identifier)) + 
  geom_point(data=subset(phenotypeMatrix,Identifier=="Elderly",stat="identity"), size=6, pch=21) + 
  geom_point(data=subset(phenotypeMatrix,Identifier=="Young",stat="identity"), size=6, pch=21) +   
  theme(axis.text = element_text(size=16,hjust = 0.5))+theme(axis.title = element_text(size=24,hjust = 0.5))+
  ggtitle("TNF vs H3N2 IgG FCd7") + theme(plot.title = element_text(size=28,hjust = 0.5)) + ylab("TNF (pg/mL)")  + xlab("Fold change of day 7 vs 0") + 
  scale_fill_manual(values=c('purple','#E69F00')) + scale_color_manual(values=c('purple', '#E69F00'))+ annotation_custom(my_grob1) + annotation_custom(my_grob2)
# ggsave(filename = "../../Analysis/Antibody data/Images/H3N2_IgG_FCd7_YandE_scatter.png", device="png")
cor.test(phenotypeMatrixYoung$H3N2.IgG.FCd7, phenotypeMatrixYoung$TNFa, use="complete")
cor.test(phenotypeMatrixElderly$H3N2.IgG.FCd7, phenotypeMatrixElderly$TNFa, use="complete")
...
a <- ggcorrplot(corrY, hc.order=FALSE, type="full",outline.col="white",lab=FALSE, p.mat=p.matY, insig="blank", tl.cex=19, colors=viridis(3) )
...
b <- ggcorrplot(corrE, hc.order=FALSE, type="full",outline.col="white",lab=FALSE, p.mat=p.matE, insig="blank", tl.cex=19, colors=viridis(3) )
